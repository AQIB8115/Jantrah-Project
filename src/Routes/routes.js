...
import AddDoctorForm from "../Pages/Doctor/AddDoctor.js";

import MyComponent from "../Pages/Doctor/MyComponent.js";
import MyData from "../Pages/Doctor/MyData.js";

import DoctorScheduleView from "../Pages/Doctor/Schedule.js";
import DoctorList from "../Pages/Doctor/DoctorViewList.js";
// import DoctorScheduleView from "../Pages/Calender/Schedule";



// Import E-mail
import AddPatientModal from "../Pages/Patients/AddPatientModal.js";
import PatientList from "../Pages/Patients/PatientList.js";
import PatientCaseStudyPage from "../Pages/Patients/PatientCaseStudyPage.js"
import PatientCaseStudyList from "../Pages/Patients/PatientCaseStudyList.js";
import AddPatientCaseStudyModal from "../Pages/Patients/AddPatientCaseStudyModal.js"
...
// import PrescriptionList from "../Pages/Prescription/PrescriptionList.js";
import PrescriptionPage from "../Pages/Prescription/PrescriptionPage.js";
import PrescriptionViewList from "../Pages/Prescription/prescriptionViewList.js";
...
const authProtectedRoutes = [
  ...
  { path: "/adddoctor", component: <AddDoctorForm /> },

  // { path: "/simple-table", component: <SimpleTable /> },
  { path: "/my-component", component: <MyComponent /> },
  { path: "/my-data-view", component: <MyData /> },

  { path: "/viewschedule", component: <DoctorScheduleView />},

  // { path: "/view-list", component: <DoctorList />},
  { path: "/view-list", component: <DoctorList />},
  ...
  // E-mail
  {path: "/createpatient", component: <AddPatientModal />},

  {path: "/view-all-Patient", component: <PatientList />},
  {path: "/patient-view", component: <PatientCaseStudyPage />},
  {path: "/patient-list", component: <PatientCaseStudyList />},
  {path: "/patient-list-create", component: <AddPatientCaseStudyModal />},
  // { path: "/inbox", component: <Inbox /> },
  // { path: "/read-email", component: <ReadEmail /> },
  // { path: "/compose-email", component: <EmailCompose /> },

  // {path: "view-prescription", component: <PrescriptionList />},
  {path: "/view-list-prescription", component: <PrescriptionPage />},
  {path: "/view-prescription", component: <PrescriptionViewList />},
  {path: "/create-prescription", component: <PrescriptionForm />},
  // Utility Pages
