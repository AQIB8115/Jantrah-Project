...
// users
import user1 from "../../../assets/images/users/male.png";
      ...
      >
        ...
        <DropdownMenu className="dropdown-menu-end">
          ...
          <DropdownItem tag="a" href="#">
            ...
            {props.t("Account Setting")}
          </DropdownItem>
          <DropdownItem tag="a" href="#">
            <span className="badge bg-success float-end mt-1"></span>
            <i className="ri-key-2-line align-middle me-2" />
